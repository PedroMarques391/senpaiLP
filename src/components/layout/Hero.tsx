...
const Hero = (): React.JSX.Element => {
    ...
    return (
        <section>
            <div
                className="relative text-content-inverse bg-gradient-to-r from-fuchsia-300 via-purple-300 to-slate-50 bg-center   md:px-20 rounded-b-[60px] overflow-hidden">
                <Image
                ...
                <section
                    ...
                    <div className="flex flex-col gap-6 z-10 px-5 md:px-0 xl:px-5 pt-32 overflow-hidden w-full justify-center items-center ">
                        <motion.h1
                            ref={ref}
                            initial={{ x: "100%" }}
                            animate={{ x: isInView ? 0 : "100%" }}
                            transition={{ type: "spring", stiffness: 100, damping: 25, duration: 0.8 }}
                            className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-center">
                        ...
                        <motion.h2
                            ...
                            className="text-lg md:text-base text-center lg:text-xl">
                        ...
                        <div className="flex flex-col gap-10">
                            ...
                            >
                                <button className="bg-[#25D366] text-content-inverse font-bold py-2 px-3 rounded-full transition flex items-center gap-4 w-full  duration-300 sm:py-1 sm:px-2 sm:gap-2 md:py-2 md:px-3 md:gap-4 hover:bg-[#1DA851] hover:scale-105 hover:shadow-lg active:scale-95 justify-center">
