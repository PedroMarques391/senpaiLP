...
const Hero = (): React.JSX.Element => {
  ...
  return (
    <section>
      <div className="relative text-content-inverse bg-gradient-to-r from-fuchsia-300 via-purple-300 to-slate-50 bg-center   md:px-20 rounded-b-[60px] overflow-hidden z-20">
        <Image
        ...
        >
          <div className="flex flex-col gap-6 px-5 md:px-0 xl:px-5 pt-32 overflow-hidden w-full justify-center  items-center lg:gap-9">
            ...
            <div className="flex flex-col gap-10 md:gap-5 w-full md:w-[80%] mb-3 ">
              ...
              >
                <button className="flex items-center justify-center gap-3  mx-auto lg:mx-0  rounded-full bg-[#25D366] p-4 font-bold text-white  transition duration-300  hover:bg-[#1DA851] ">
                  <BsWhatsapp aria-label="Ícone do WhatsApp" className="w-6 h-6 flex-shrink-0" />
                  {t("cta")}
                </button>
              </Link>
            ...
            <div className="relative mx-auto border-gray-800 border-[10px] rounded-[2.5rem] -mb-30 mt-10 lg:mt-30 z-10">
              ...
              <div className="rounded-[2rem] overflow-hidden bg-surface-card-alt">
                <video
                  ...
                  className="z-0"
                >
                  <source src={`/videos/${locale}.mp4`} type="video/mp4" />
                  {t("videoSupport")}
                </video>
              </div>
            ...
            >
              <CardHeader>
                <CardTitle className="text-2xl lg:text-3xl font-bold tracking-tight ">
                  ...
                  >
                    <Counter
                      number={achievement.title as number}
                      type={t(`type.${achievement.type}`)}
                    />
                  </motion.h1>
                </CardTitle>
              </CardHeader>
