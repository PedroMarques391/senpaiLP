...
export const Header = ({ background }: IHeaderProps): React.JSX.Element => {
    ...
    return (
        <header className={`text-white py-3 flex justify-center font-sans items-center fixed top-0 left-0 transition-colors duration-500 w-full z-30 ${scrolled ? "bg-senpai-header/90" : background
            }`}>
