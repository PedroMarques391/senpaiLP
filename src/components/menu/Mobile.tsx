      ...
      {isOpen && (
        ...
        >
          <motion.div variants={variants}>
            <NavItem onClick={() => setIsOpen(false)} href={handleHref("home")}>
              {t("home")}
            </NavItem>
          </motion.div>
          <motion.div variants={variants}>
            <NavItem onClick={() => setIsOpen(false)} href={handleHref("func")}>
              {t("features")}
            </NavItem>
          </motion.div>
          <motion.div variants={variants}>
            <NavItem onClick={() => setIsOpen(false)} href={handleHref("plans")}>
              {t("subscriptions")}
            </NavItem>
          </motion.div>
          <motion.div variants={variants}>
            <NavItem onClick={() => setIsOpen(false)} href="/about">
              {t("aboutUs")}
            </NavItem>
          </motion.div>
          <motion.div variants={variants}>
            <NavItem onClick={() => setIsOpen(false)} href="/partners">
              {t("beAPartner")}
            </NavItem>
          </motion.div>
          <li>
